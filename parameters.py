...
PATH_INSTRUCTIONS_NO_EXAMPLES = (
    f"data/separate_examples_from_text/{ASSISTANT_NAME}_text_without_examples.txt"
)
...
PATH_ASSISTANT_ID_FINE_TUNED_TXT = (
    f"data/assistants_ids/{ASSISTANT_NAME}_fine_tuned_assistant_id.txt"
)
...
# The CSV with the base assistant's answers
PATH_TEST_RESULTS_BASE_CSV = f"data/test/{ASSISTANT_NAME}_base_test_results.csv"

# The CSV with the fine-tuned assistant's answers
PATH_TEST_RESULTS_FINE_TUNED_CSV = f"data/test/{ASSISTANT_NAME}_fine_tuned_test_results.csv"

# The CSV that unifies base vs. fine-tuned results 
PATH_TEST_RESULTS_UNIFIED_CSV = f"data/evaluator/{ASSISTANT_NAME}_unified_results.csv"
