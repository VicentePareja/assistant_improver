...
INTRUCTIONS_STATIC_EVALUATOR_PATH = f'evaluator_prompt/static/{NAME}_static_evaluator_promt.txt'
...
RESPONSES_STATIC_EVALS_PATH_PREFIX = f'data/evaluator/{NAME}_'
UNIFIED_STATIC_RESULTS_PATH = f'data/evaluator/{NAME}_unified_results.csv'